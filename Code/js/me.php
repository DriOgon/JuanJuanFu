...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['introduction'])) {
    ...
    if (mb_strlen($introduction) > 500) {
        echo "<script>alert('简介长度不能超过500字'); window.location.href='me.php';</script>";
        exit;
    }
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="profile-container" id="profile-intro" style="margin-top: 20px; display: block;">
                ...
                <div class="intro-content" onclick="editIntro(this)">
                    <?php echo htmlspecialchars($userData['introduction']); ?>
                </div>
            </div>
    ...
    <script>
        ...
        function editIntro(element) {
            ...
            textarea.className = 'intro-editing';
